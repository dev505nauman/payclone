                        ...
                        @if($merge!=null)
                            @foreach($merge as $mergee)
                                <tr id="user{{$mergee['id']}}">
                                    <td><input class="customCheckClass" type="checkbox" name="customCheck[]" onclick="checkboxesClick(this,1)" value="{{$mergee['id']}}"></td>
                                    <td class="fname_disp"><a href="{{route('customer-detail',['id'=>$mergee['id']])}}">{{$mergee['fname']}}</a></td>
                                    <td class="lname_disp"><a href="{{route('customer-detail',['id'=>$mergee['id']])}}">{{$mergee['lname']}}</a></td>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form method="post" action="{{route('merge-customer-save')}}">
        ...
        <div class="modal-body">
         ...
         <div class="modal-footer">
             <p style="float:left;color:red;">The customers once merged cannot be unmerged in future!</p>
        <button type="submit" class="btn btn-success">Yes</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal">No</button>
      </div>
      </form>
