...
input[type=number] {
 ...
 <nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Reportings</li>
  </ol></nav>
<div class="panel">
    ...
    <h3 class="panel-heading" style="display:block;">Reportings
  <a class="btn btn-primary pull-right" onclick="dynamicSearch()" style="margin-right:3px;">Search</a>
  <a class="btn btn-primary pull-right" style="margin-right:3px;" href="{{ url('/all-reportingLogs-csv')}}">Export</a>
 ...
 <div class="table-responsive">
  ...
  <tbody id="customTable">
       ...
       <tr>
           ...
           <td>{{$rep->logsname()->where('id','=',$rep->wallet_id)->first()->name}} </td>
           <td>Refund</td>
           <td><a href="#" onclick="viewReport({{$rep->wallet_id}})" title="View Full Report"><i class="fa fa-eye"></i></a></td>
        ...
        success:function(data)
        {
          ...
          if(data['data']!=null){
            ...
            for(i=0; i<data['data'].length; i++){
                html+="<tr><td>"+j+"</td><td>"+data['data'][i]['bank_name']+"</td><td>"+data['data'][i]['amount']+"</td><td>"+data['data'][i]['date']+"</td></tr>";
                j++;
        }
