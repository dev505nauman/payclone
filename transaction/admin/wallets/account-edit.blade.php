    ...
    <div class="row">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 style="display:inline;">{{$bank_account['name']}}</h3><a href="{{url()->previous()}}" class="btn btn-primary float-right" style="display:inline;">Go Back</a>
               </div>
        </div>
        </div>
        <div class="col-md-8">
                        ...
                        <form action="{{route('account-edit')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 bars">
                              ...
                              <div class="input-group">
                                    <input type="text" class="form-control" name="bank_percent" value="{{$bank_account['amount_percent']}}" placeholder="Percentage amount that will go into this account from batch" required>
