      ...
      <div class="collapse" id="batchOptions" >
          <div class="panel panel-body dropdown">
                <ul class="unstyled centered dropdown-list" style="list-style-type:none; margin-left:-60px;">
                    <li>
                         <span class="search-input" style="margin-right:-15px;"><input type="text" class="form-control" id="accountNo" placeholder="Search Account No."></span>
                       <a class="btn btn-primary search-button float-right">Location</a>
                    </li>
                    <li>
                         <span class="search-input" style="margin-right:-15px;"><input type="text" class="form-control" id="accountNo" placeholder="Search Account No."></span>
                       <a class="btn btn-primary search-button float-right">Account No.</a>
                    </li>
                    <li>
                         <span class="search-input" style="margin-right:-15px;"><input type="text" class="form-control" id="terminal" placeholder="Search Terminal"></span>
                       <a class="btn btn-primary search-button float-right">Terminal</a>
                    </li>
                    <li>
                         <span class="search-input" style="margin-right:-15px;"><input type="text" class="form-control" id="cardNo" placeholder="Search Card No"></span>
                       <a class="btn btn-primary search-button float-right">Card No.</a>
                    </li>
                    <li>
                         <span class="search-input" style="margin-right:-15px;"><input type="text" class="form-control" id="batchType" placeholder="Search Batch Type"></span>
                       <a class="btn btn-primary search-button float-right" onclick="batchSearch()">Batch Type</a>
                    </li>
                    <li>
                         <span class="search-input" style="margin-right:-15px;"><input type="text" class="form-control" id="dataSelector" placeholder="Search Date"></span>
                       <a class="btn btn-primary search-button float-right">Date Selector</a>
                    </li>
                     <li>
                     <li>
                        <a class="btn btn-primary" href="{{ url('/all-batches-csv')}}">Export</a>
                    </li>
                </ul>
            </div>
        </div>
